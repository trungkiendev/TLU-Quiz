<?php
$sql3 = "SELECT * FROM giang_vien
WHERE giang_vien.ma_giang_vien = '$_GET[id]'";
$run3 = mysqli_query($conn,$sql3);
$dong3 = mysqli_fetch_array($run3);
?>

<form action="modules/quanlygiangvien/xuly.php?id=<?php echo $dong3['ma_giang_vien'] ;?>" method="post" enctype= "multipart/form-data">
<table  class="table table-striped table-hover table-bordered table-sm">
<tr>
<td colspan = "2"><div align ="center">Sửa chi giảng viên</div></td>
...
<a href="index.php?quanly=quanlygiangvien&ac=them">Thêm</a>
</td>
