    ...
    if($count == 0){
        ...
        ?>
            ...
            <table style="margin-left: 10px;">
                <tr>
                    <td >
                        <input type="radio" name="r1" id="r1" value="<?php echo $opt1 ?>" onclick="radioonclick(this.value,<?php echo $question_no ?>)"
                        <?php
                            if($ans == $opt1){
                                echo "checked";
                            }
                ...
                <tr>
                    <td >
                        <input type="radio" name="r1" id="r1" value="<?php echo $opt2 ?>" onclick="radioonclick(this.value,<?php echo $question_no ?>)"
                        <?php
                            if($ans == $opt2){
                                echo "checked";
                            }
                ...
                <tr>
                    <td >
                        <input type="radio" name="r1" id="r1" value="<?php echo $opt3 ?>" onclick="radioonclick(this.value,<?php echo $question_no ?>)"
                        <?php
                            if($ans == $opt3){
                                echo "checked";
                            }
                ...
                <tr>
                    <td >
                        <input type="radio" name="r1" id="r1" value="<?php echo $opt4 ?>" onclick="radioonclick(this.value,<?php echo $question_no ?>)"
                        <?php
                            if($ans == $opt4){
                                echo "checked";
                            }
